...
start dotnet publish -o "%DIR_NAME%/bin/textRankCalc" -c Release TextRankCalc/TextRankCalc.csproj
...
@echo start bin/textRankCalc/TextRankCalc.exe >> "%DIR_NAME%/start.bat"
...
@echo taskkill /IM TextRankCalc.exe >> "%DIR_NAME%/stop.bat" 